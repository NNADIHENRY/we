...
import com.HITech.jambquiz.adapter.LanguageAdapter;
import com.HITech.jambquiz.adapter.MainAdapter;
...
import com.HITech.jambquiz.receiver.AlarmReceiver;
...
import static com.HITech.jambquiz.utils.Constant.getLanguageCode;
import static com.HITech.jambquiz.utils.Constant.setDefaultLanguage;
import static com.HITech.jambquiz.utils.Constant.setLanguageCode;
...
public class MainActivity extends AppCompatActivity
    ...
    public void mainItemClick(int main_id, int position, String title, int themePosition) {
        ...
        if (main_id == 3) {
            ...
            tableName = getString(R.string.economics_data_table);
        } else if (main_id == 4) {
