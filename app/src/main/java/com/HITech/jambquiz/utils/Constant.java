package com.HITech.jambquiz.utils;
...
import com.HITech.jambquiz.R;
import com.HITech.jambquiz.database.DatabaseAccess;
import com.HITech.jambquiz.methods.TitleStrings;
import com.HITech.jambquiz.model.ColorModel;
import com.HITech.jambquiz.model.HistoryModel;
import com.HITech.jambquiz.model.MainModel;
import com.HITech.jambquiz.model.OperationModel;
import com.HITech.jambquiz.model.StoreSetModel;
import com.HITech.jambquiz.ui.ActivityDailyTest;
...
public class Constant {
    ...
    public static List<MainModel> getMainModel(Activity context) {
        ...
        mainModelList.add(new MainModel(1, context.getString(R.string.jamb), getIntegerQuiz(context), getOperationList(context)));
        mainModelList.add(new MainModel(2, "", getDecimalQuiz(context), getOperationList(context)));
        mainModelList.add(new MainModel(3, "", (QUIZ_SIZE * 4), getOperationList(context)));
        mainModelList.add(new MainModel(4, "", (LEVEL_SIZE * 6), getMixedOperationList(context)));
    ...
    public static String getPdfTitle(Activity context, String tableName) {
        ...
        if (tableName.equals(context.getString(R.string.str_addition))) {
            return context.getString(R.string.maths_set);
        } else if (tableName.equals(context.getString(R.string.str_multiplication))) {
            return context.getString(R.string.agric_set);
        } else if (tableName.equals(context.getString(R.string.str_division))) {
            return context.getString(R.string.biology_set);
        } else {
            return context.getString(R.string.english_set);
        }
    }
    ...
    public static void getfirstOpertaion(Activity context, List<OperationModel> mainModelList) {
        setDefaultLanguage(context);
        mainModelList.clear();
        mainModelList.add(new OperationModel(context.getString(R.string.maths), false, 1));
        mainModelList.add(new OperationModel(context.getString(R.string.english), false, 2));
        mainModelList.add(new OperationModel(context.getString(R.string.agric), false, 3));
        mainModelList.add(new OperationModel(context.getString(R.string.biology), false, 4));


    }
    public static void getsecondOpertaion(Activity context, List<OperationModel> mainModelList) {
        setDefaultLanguage(context);
        mainModelList.clear();
        mainModelList.add(new OperationModel(context.getString(R.string.geography), false, 1));
        mainModelList.add(new OperationModel(context.getString(R.string.government), false, 2));
        mainModelList.add(new OperationModel(context.getString(R.string.lit), false, 3));
        mainModelList.add(new OperationModel(context.getString(R.string.history), false, 4));


    }
    public static void getthirdOpertaion(Activity context, List<OperationModel> mainModelList) {
        setDefaultLanguage(context);
        mainModelList.clear();
        mainModelList.add(new OperationModel(context.getString(R.string.chemistry), false, 1));
        mainModelList.add(new OperationModel(context.getString(R.string.physics), false, 2));
        mainModelList.add(new OperationModel(context.getString(R.string.crk), false, 3));
        mainModelList.add(new OperationModel(context.getString(R.string.irk), false, 4));
    ...
    public static void getIntegerOrMixedOpertaion(Activity context, List<OperationModel> mainModelList) {
        ...
        mainModelList.add(new OperationModel(context.getString(R.string.agric), false, 3));
        mainModelList.add(new OperationModel(context.getString(R.string.biology), false, 4));
        mainModelList.add(new OperationModel(context.getString(R.string.biology), false, 5));
        mainModelList.add(new OperationModel(context.getString(R.string.biology), false, 6));
        mainModelList.add(new OperationModel(context.getString(R.string.biology), false, 7));


        mainModelList.add(new OperationModel(context.getString(R.string.account), false, 8));
        mainModelList.add(new OperationModel(context.getString(R.string.commerce), false, 9));
        mainModelList.add(new OperationModel(context.getString(R.string.economics), false, 10));
        mainModelList.add(new OperationModel(context.getString(R.string.lit), false, 11));
        mainModelList.add(new OperationModel(context.getString(R.string.crk), false, 12));
        mainModelList.add(new OperationModel(context.getString(R.string.irk), false, 13));
    ...
    public static void getMixedOpertaion(Activity context, List<OperationModel> mainModelList) {
        setDefaultLanguage(context);
        mainModelList.clear();
        mainModelList.add(new OperationModel(context.getString(R.string.account), false, 5));
        mainModelList.add(new OperationModel(context.getString(R.string.commerce), false, 6));
        mainModelList.add(new OperationModel(context.getString(R.string.economics), false, 7));
        mainModelList.add(new OperationModel(context.getString(R.string.lit), false, 8));
        mainModelList.add(new OperationModel(context.getString(R.string.crk), false, 9));
        mainModelList.add(new OperationModel(context.getString(R.string.irk), false, 10));
    }
    ...
    public static List<OperationModel> getAllOperationTypeList(Activity context, List<String> operationList) {
        ...
        for (int i = 0; i < operationList.size(); i++) {
            if (operationList.get(i).contains(context.getString(R.string.maths))) {
            ...
            if (operationList.get(i).contains(context.getString(R.string.english))) {
            ...
            if (operationList.get(i).contains(context.getString(R.string.biology))) {
